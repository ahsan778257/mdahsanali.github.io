...
if (isset($_POST["btn"])){
    ...
    $sql ="INSERT INTO `customers1`(`first_name`, `last_name`, `email`, `message`)
            VALUES ('[$firstName]','[$lastName]','[$email]','[$message]')";

   $query =  mysqli_query($connection,$sql);
    if ($query){
        echo  "<h1 class='text-danger fw-bolder'>Your Information is Successfully Send</h1>";
...
<head>
    ...
    <title>This is Md Ahsan. I am a Web Developer     </title>
</head>
...
<div class="container-fluid 100vh home">
    <img src="images/ahsan%20formal%20p.jpg" class="rounded-circle img-fluid" style="height: 200px;width: 200px">
    <br>
    <br>
...
<div class="container-fluid  100vh about" id="about">
    <div class="row">
        ...
        <div class="col-sm-6">
            <img class="about-image" src="images/md%20ahsan%20ali.jpg">
        </div>
...
<div class="container-md" id="portfolio">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="images/md%20ahsan%20ali.jpg" style="width: 350px; height: 300px">
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
